...
export function renderTrophies(data, t = tokyonight) {
  ...
  tr.forEach((c, i) => {
    ...
    inner.push(text(x + chipW / 2, top + 36, c.rank, { fill: t.gold, size: 22, weight: 700, anchor: 'middle' }));
    inner.push(text(x + chipW / 2, top + 58, c.kind, { fill: t.dim, size: 12, anchor: 'middle' }));
  });
